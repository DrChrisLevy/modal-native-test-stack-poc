...
class SandboxSession:
    ...
    def environment(self) -> dict[str, str]:
        ...
        return {
            ...
            "MODAL_ML_MODELS_ROOT": MODEL_MOUNT,
            "MODAL_ML_MODELS_LOCK_PATH": "/workspace/models.lock.json",
            "MODAL_ML_POSTGRES_URL": postgres_url,
            "MODAL_ML_REDIS_URL": "redis://redis:6379/0",
            "MODAL_ML_OPENSEARCH_URL": "http://opensearch:9200",
